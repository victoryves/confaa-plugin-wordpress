...
class JornalDeAlagoasScraper(BaseScraper):
    ...
    def get_article_links(self, page) -> list[str]:
        ...
        for a in page.css("a[href]"):
            ...
            if href.startswith("https://jornaldealagoas.com.br/") and len(href) > 35:
    ...
    def parse_article(self, page, url: str) -> Article | None:
        ...
        body_el = page.css_first(".entry-content") or page.css_first("article .post-body") or page.css_first("article")
...
def handler(request):
    scraper = JornalDeAlagoasScraper()
